...
export function seedRoles(): Role[] {
  return [
    ...
    // New roles below
    {
      id: 'role-cloud-root-admin',
      name: 'Cloud Root Admin',
      description: 'Unrestricted access to all cloud infrastructure and resources.',
      sensitivity: 'CRITICAL',
      domains: ['CLOUD_INFRA', 'PRODUCTION_DB', 'CUSTOMER_DATA'],
    },
    {
      ...
      sensitivity: 'CRITICAL',
      domains: ['SECURITY_CENTER', 'PRODUCTION_DB'],
    },
    {
      id: 'role-hr-manager',
      name: 'HR Manager',
      description: 'Manages employee records and sensitive HR data.',
      sensitivity: 'HIGH',
      domains: ['HR_SYSTEM', 'EMPLOYEE_DATA'],
    },
    {
      id: 'role-customer-support-lead',
      name: 'Customer Support Lead',
      description: 'Leads support team and has access to customer tickets and PII.',
      sensitivity: 'MEDIUM',
      domains: ['SUPPORT_PORTAL', 'CUSTOMER_DATA'],
    },
    {
      id: 'role-devops-engineer',
      name: 'DevOps Engineer',
      description: 'Manages CI/CD pipelines and production deployments.',
      sensitivity: 'CRITICAL',
      domains: ['CI_CD', 'PRODUCTION_DB', 'CLOUD_INFRA'],
    },
  ];
}
